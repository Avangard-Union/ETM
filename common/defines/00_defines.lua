...
NDiplomacy = {
	...
	TRUCE_BREAK_COST_PP = 5200,						-- Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
	...
	BASE_PEACE_FORCE_GOVERNMENT_COST = 2600, 		-- Base cost for forcing a country to change government.
	...
	BASE_IMPROVE_RELATION_COST = 260,                -- Political power cost to initiate relation improvement
	BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 15.2, -- Political power cost each update when boosting relations with nation of same ideology
	BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 10.4,    -- Political power cost each update when boosting relations with nation of different ideology
	BASE_SEND_ATTACHE_COST = 2600,					-- Political power cost to send attache
	BASE_SEND_ATTACHE_CP_COST = 50.0,				-- Command Power sent attache usage cost
	BASE_GENERATE_WARGOAL_DAILY_PP = 15.2,	-- Daily pp cost for generation of wargoals
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -507, 	-- reduction of pp cost for wargoal vs major at war.
	WARGOAL_WORLD_TENSION_REDUCTION = -338,			-- Reduction of pp cost for wargoal at 100% world tension, scales linearly
	...
	MIN_WARGOAL_JUSTIFY_COST = 52.0,					-- It always takes atleast 10 days to justify a wargoal
	WARGOAL_PER_JUSTIFY_AND_WAR_COST_FACTOR = 39,	-- Cost factor per nation at war with or justifying against
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 169, 	-- Daily pp cost for boost party popularity
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.1, 	-- Daily amount of popularity that will be added by the activity.
	BASE_STAGE_COUP_DAILY_PP = 338,					-- Daily pp cost for staging a coup
	...
	TENSION_DECAY_DAILY = 0.005,					-- Each day tension decays this much for Threat sources which are no longer relevant. Replaces TENSION_DECAY as of 1.12.0				-- Each months tension decays this much
...
PEACE_SCORE_SCALE_FACTOR = 1.35,                -- Losers' total value times this factor becomes the default total peace conference score that is distributed to the winners.
	...
	AUTONOMY_LEVEL_CHANGE_PP_COST_BASE = 1300.0,		-- Base cost of changing level of autonomy
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 7800,			-- Annexation cost
	AUTONOMY_LEVEL_CHANGE_PP_FREE = 7800,			-- Break free cost
	...
	ASSUME_FACTION_LEADERSHIP_PP_COST = 5200,				-- Political power cost to assume faction leadership
...
NCountry = {
	...
	POLITICAL_POWER_LOWER_CAP = -1050000.0,				-- Min amount of political power country should have
	POLITICAL_POWER_UPPER_CAP = 2100000.0,				-- Max amount of political power country should have
	...
	SCORCHED_EARTH_STATE_COST = 130,					-- pp cost to scorch a state
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 26,	-- Weekly increase of PP.
...
NAir = {
	...
	COMBAT_BETTER_SPEED_DAMAGE_INCREASE = 0.60, 		-- How much the better Speed (than opponent's) can reduce increase our damage to them.
														...
														-- In both cases the maximum bonus or reduction is (BIGGEST_X_FACTOR_DIFF - 1) * COMBAT_BETTER_X_DAMAGE_Y * 												 
...
NAI = {
	...
	DIPLOMACY_FACTION_WAR_RELUCTANCE = -10000,		-- Penalty to desire to enter a faction with a country that we are not fighting wars together with.
	...
	MAX_PP_TO_SPEND_ON_LOWER_PRIO_TASKS = 1000,			-- max pp cost for ai to allow spend pp on lower prio things while a higher prio things are available
...
NOperatives = {
	...
	BECOME_SPYMASTER_PP_COST = 1300,					-- Number of political power used to become Spy Master
...
NCharacter = {
	...
	DEFAULT_PP_COST_FOR_MILITARY_ADVISOR = 1300,	-- When an advisor does not have cost assigned this is the default used
	DEFAULT_PP_COST_FOR_POLITICAL_ADVISOR = 3900,
